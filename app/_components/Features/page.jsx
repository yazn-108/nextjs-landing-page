...
const Page = () => {
  return (
    <section id="features" className="p-4 my-6 md:p-8 text-gray-100">
      <h1 className="capitalize text-center title-font mb-4 text-2xl font-medium text-white sm:text-3xl">
        our Features
      </h1>
      <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
        {FeatureDetails.map((e, i) => (
          <Feature
            key={i}
