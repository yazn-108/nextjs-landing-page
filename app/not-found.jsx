    ...
    <section className="h-dvh grid place-content-center">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <Link
            href="/"
            className="transition-all inline-flex text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-primary my-4"
          >
            Back to Homepage
          </Link>
        </div>
